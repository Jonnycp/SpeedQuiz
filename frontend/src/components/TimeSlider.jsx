...
const TimeSlider = ({ tempoIniziale = 45 }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-[92%] md:w-full max-w-3xl mx-auto my-6 font-primary relative z-10">
      <div className="w-full h-6 md:h-8 bg-white border-3 border-neroNonNero rounded-full shadow-[6px_6px_0_0_#000] overflow-hidden">
        <div 
      ...
      <div className="bg-neroNonNero text-white font-black text-sm md:text-base uppercase px-6 py-1.5 rounded-full min-w-[140px] text-center">
