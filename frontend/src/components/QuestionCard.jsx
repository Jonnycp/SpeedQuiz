...
const Question = () => {
    ...
    return(
        <div className="flex flex-col items-center mt-30 md:mt-30 px-4 gap-6 w-full mx-auto md:max-w-3xl"> 
            ...
            <form className="w-[80%]">
                ...
                <div className="flex flex-col gap-5 *:w-full *:px-4 md:*:px-6 *:py-3 md:*:py-4 *:text-sm md:*:text-lg *:border-3 *:border-neroNonNero *:shadow-buttons mt-7 *:placeholder:text-gray-400">
                    <input placeholder="Inserisci la risposta..." className="bg-white -rotate-[1.2deg]"></input>
                    <input placeholder="Inserisci la risposta..." className="bg-white rotate-1"></input>
                    <input placeholder="Inserisci la risposta..." className="bg-white md:z-10"></input>
                </div>

                <div className="w-1/2 mx-auto mt-15">
                    <ConfirmButton content="Invia" customClasses="w-full bg-primary text-white -rotate-1 py-4 md:py-3 text-3xl md:text-4xl"/>
                </div>
