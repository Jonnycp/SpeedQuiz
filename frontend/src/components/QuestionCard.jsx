    ...
    return(
        <div className="flex flex-col items-center mt-30 md:mt-50 px-4 gap-6 w-full max-w-2xl mx-auto"> 
            <div className="relative w-full bg-white shadow-buttons border-3 border-neroNonNero px-6 py-6 md:px-17 md:py-8 rounded-2xl select-none">
                <h2 className="text-xl md:text-3xl font-extrabold text-center">Tre cose che vorresti dire a Ferrara </h2>
                <p className="absolute uppercase -top-5 -left-4 bg-[#FFDF9A] shadow-buttons text-xs px-3 py-1 font-bold -rotate-2 select-none md:text-base">domanda flash</p>
            ...
            <form className="w-[80%]">
                ...
                <div className="w-1/2 mx-auto mt-9">
                    <ConfirmButton content="Invia" customClasses="w-full bg-primary text-white -rotate-1 py-4 md:py-5 text-xl md:text-4xl"/>
                </div>
