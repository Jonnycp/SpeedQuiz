...
function calculateMatchWinner(lobby, match){
    ...
    const scoreP1 = calculateScore(lobby.currentRound, votedForP1, lobby.players.size-2)
    const scoreP2 = calculateScore(lobby.currentRound, votedForP2, lobby.players.size-2)
...
//* Funzione per calcolare punteggi
// Round*10 + %preferenza + bonus (se 100%)
